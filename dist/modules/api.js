...
Structure avec des titres clairs (## et ###). Commence directement sans préambule.`;
    ...
    buildCaseSystem(caseName, caseDomain, notes, skills, mode) {
