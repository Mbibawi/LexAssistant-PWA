...
async function mountBibliotheque(): Promise<void> {
  await updateTopBar("Bibliothèque", "📁 Dossiers", () =>
    mountDossiers(),
  );
...
async function updateTopBar(label: string, switchTo: string, action: Function): Promise<void> {
